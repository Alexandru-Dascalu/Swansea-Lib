...
public abstract class Notification {
    ...
    /**
     * The height of the image view an image associated with this notification has.
     * Its value is {@value}.
     */
    protected static final int IMAGE_HEIGHT = 200;

    /**
     * The width of the image view an image associated with this notification has.
     * Its value is {@value}.
     */
    protected static final int IMAGE_WIDTH = 120;

    /**
     * The wrap width of the text showing the message of the notification in the
    ...
    /**
     * Associates the notification with the given id to the given user in the
     * database.
     * 
     * @param notificationID The id of the notification that is sent to this user.
     ...
     * Notifications are considered to be identical if they have the same message
     * and date. So users do not get repeating notifications, we check if a
     * notification like we need already exists.
     * 
     * @param message The message of a notification we search for.
     * @param date The date of a notification we search for.
     * @return The unique ID of an already existing notification that has the given
     *         details, or -1 of no such notification exists in the database.
     */
    ...
    /**
     * Checks in the database to see if a notification is already associated with a
     * user or not.
     * 
     * @param notificationID The ID of the notification.
     * @param userName The user name of the user.
     * @return True if the user is already associated with the notification in the
    ...
    /**
     * Sets the isRead flag to true if it was false. If not, it throws an exception.
     * 
    ...
    public void setRead() {
        if (isRead) {
            throw new IllegalStateException(
                "Called setRead when notification" + " is already read!");
        }
        isRead = true;
    }
    ...
    /**
     * Gets the an empty Text element which should be used to display the message.
     * It has the wrapping width set to TEXT_WRAP_WIDTH.
     * 
    ...
    /**
     * Makes an empty node that can be used to space out elements in an HBox. Used
     * with event notifications so text is aligned with the other notifications,
     * since event notifications do not display images. Its height depends on the
     * height of the ImageViews used to display resource images.
     * 
